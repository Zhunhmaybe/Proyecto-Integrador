...
<head>
    ...
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.5.1/css/all.min.css">
     @vite(['resources/css/doctor/citas/create.css'])
</head>
    ...
    <div class="wrapper">
        ...
        <main class="content">
            ...
            <div class="panel mb-4">
                ...
                <form method="GET" action="{{ route('doctor.citas.create') }}" class="row g-3">
                    ...
                    <div class="col-md-2">
                        <a href="{{ route('doctor.pacientes.create') }}" class="btn btn-outline-secondary w-100">
                            Crear
                        </a>
                    </div>
                </form>
                @if (session('paciente_no_encontrado'))
                    <div class="alert alert-warning d-flex justify-content-between align-items-center mt-3">
                        ...
                        <a href="{{ route('doctor.pacientes.create', ['cedula' => session('paciente_no_encontrado')]) }}"
                            class="btn btn-gold">
                            Crear Paciente
                        </a>
                    </div>
            ...
            <div class="panel">
                ...
                <form method="POST" action="{{ route('doctor.citas.store') }}">
                    ...
                    <div class="text-end mt-4">
                        <a href="{{ route('doctor.citas.create') }}" class="btn btn-light">
                            Cancelar
                        </a>
