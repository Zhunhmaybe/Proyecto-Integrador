                    ...
                    <div class="row mt-3">
                        <div class="col-md-3">
                            <div class="form-check form-switch">
                                <input class="form-check-input" type="checkbox" name="cardiopatias" id="cardiopatias"
                                    value="1" {{ old('cardiopatias') ? 'checked' : '' }}>
                        ...
                        <div class="col-md-3">
                            <div class="form-check form-switch">
                                <input class="form-check-input" type="checkbox" name="diabetes" id="diabetes"
                                    value="1" {{ old('diabetes') ? 'checked' : '' }}>
                                <label class="form-check-label" for="diabetes">Diabetes</label>
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div class="form-check form-switch">
                                <input class="form-check-input" type="checkbox" name="hipertension" id="hipertension"
                                    value="1" {{ old('hipertension') ? 'checked' : '' }}>
                        ...
                        <div class="col-md-3">
                            <div class="form-check form-switch">
                                <input class="form-check-input" type="checkbox" name="tuberculosis" id="tuberculosis"
                                    value="1" {{ old('tuberculosis') ? 'checked' : '' }}>
            ...
            <div class="card mb-4">
                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-3">
                            <div class="form-check form-switch">
                                <input class="form-check-input" type="checkbox" name="fam_diabetes" id="fam_diabetes"
                                    value="1" {{ old('fam_diabetes') ? 'checked' : '' }}>
                                <label class="form-check-label" for="fam_diabetes">Diabetes</label>
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div class="form-check form-switch">
                                <input class="form-check-input" type="checkbox" name="fam_hipertension"
                                    id="fam_hipertension" value="1" {{ old('fam_hipertension') ? 'checked' : '' }}>
                                <label class="form-check-label" for="fam_hipertension">Hipertensión</label>
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div class="form-check form-switch">
                                <input class="form-check-input" type="checkbox" name="fam_cancer" id="fam_cancer"
                                    value="1" {{ old('fam_cancer') ? 'checked' : '' }}>
                                <label class="form-check-label" for="fam_cancer">Cáncer</label>
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div class="form-check form-switch">
                                <input class="form-check-input" type="checkbox" name="fam_tuberculosis"
                                    id="fam_tuberculosis" value="1" {{ old('fam_tuberculosis') ? 'checked' : '' }}>
                ...
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-md-3">
                            ...
                            <input type="number" name="pulso" class="form-control" placeholder="70"
                                value="{{ old('pulso') }}">
                        </div>
                        <div class="col-md-3">
            ...
            <div class="card mb-4">
                ...
                <div class="card-body">
                    <div class="row g-3">
                        ...
                        {{-- Labios --}}
                        <div class="col-md-3">
                            <label class="form-label small fw-bold mb-1">Labios</label>
                            <select name="labios" class="form-select form-select-sm">
                                <option value="">Seleccione</option>
                                <option value="Normal">Normal</option>
                                <option value="Queilitis">Queilitis</option>
                        ...
                        {{-- Lengua --}}
                        <div class="col-md-3">
                            <label class="form-label small fw-bold mb-1">Lengua</label>
                            <select name="lengua" class="form-select form-select-sm">
                                <option value="">Seleccione</option>
                                <option value="Normal">Normal</option>
                                <option value="Lengua saburral">Lengua saburral</option>
                                <option value="Glositis">Glositis</option>
                        ...
                        {{-- Paladar --}}
                        <div class="col-md-3">
                            <label class="form-label small fw-bold mb-1">Paladar</label>
                            <select name="paladar" class="form-select form-select-sm">
                                <option value="">Seleccione</option>
                                <option value="Normal">Normal</option>
                                <option value="Eritematoso">Eritematoso</option>
                                <option value="Úlcera">Úlcera</option>
                                <option value="Candidiasis">Candidiasis</option>
                                <option value="Torus palatino">Torus palatino</option>
                                <option value="Fisura palatina">Fisura palatina</option>
                            </select>
                        </div>

                        {{-- Piso de Boca --}}
                        <div class="col-md-3">
                            <label class="form-label small fw-bold mb-1">Piso de Boca</label>
                            <select name="piso_boca" class="form-select form-select-sm">
                                <option value="">Seleccione</option>
                                <option value="Normal">Normal</option>
                                <option value="Inflamación">Inflamación</option>
                                <option value="Ranula">Ranula</option>
                                <option value="Sialolitiasis">Sialolitiasis</option>
                                <option value="Úlcera">Úlcera</option>
                            </select>
                        </div>
                        ...
                        {{-- Encías --}}
                        <div class="col-md-3">
                            <label class="form-label small fw-bold mb-1">Encías</label>
                            <select name="encias" class="form-select form-select-sm">
                                <option value="">Seleccione</option>
                                <option value="Normal">Normal</option>
                        ...
                        {{-- Carrillos --}}
                        <div class="col-md-3">
                            <label class="form-label small fw-bold mb-1">Carrillos</label>
                            <select name="carrillos" class="form-select form-select-sm">
                                <option value="">Seleccione</option>
                                <option value="Normal">Normal</option>
                                <option value="Mordedura de carrillo">Mordedura de carrillo</option>
                                <option value="Úlcera">Úlcera</option>
                        ...
                        {{-- Orofaringe --}}
                        <div class="col-md-3">
                            <label class="form-label small fw-bold mb-1">Orofaringe</label>
                            <select name="orofaringe" class="form-select form-select-sm">
                                <option value="">Seleccione</option>
                                <option value="Normal">Normal</option>
                                <option value="Eritematosa">Eritematosa</option>
                                <option value="Amigdalitis">Amigdalitis</option>
                                <option value="Exudado purulento">Exudado purulento</option>
                                <option value="Hipertrofia amigdalina">Hipertrofia amigdalina</option>
                            </select>
                        </div>

                        {{-- ATM --}}
                        <div class="col-md-3">
                            <label class="form-label small fw-bold mb-1">ATM</label>
                            <select name="atm" class="form-select form-select-sm">
                                <option value="">Seleccione</option>
                                <option value="Normal">Normal</option>
                                <option value="Dolor">Dolor</option>
                                <option value="Chasquido">Chasquido</option>
                                <option value="Limitación de apertura">Limitación de apertura</option>
